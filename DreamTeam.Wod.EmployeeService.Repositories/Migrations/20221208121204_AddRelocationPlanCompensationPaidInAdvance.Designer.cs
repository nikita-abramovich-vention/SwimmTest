...
namespace DreamTeam.Wod.EmployeeService.Repositories.Migrations
{
    ...
    [Migration("20221208121204_AddRelocationPlanCompensationPaidInAdvance")]
    partial class AddRelocationPlanCompensationPaidInAdvance
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.Employee", b =>
                {
                    ...
                    b.Property<bool?>("IsRemoteContract")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.EmployeeUnitChange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NewUnitId")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<string>("PreviousUnitId")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.ExternalOffice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CitySourceId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CitySourceName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.Office", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ExternalOfficeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.Repositories.EmployeeServiceDbContext+DismissalReasons", b =>
                {
                    ...
                    b.ToTable("DismissalReason", (string)null);
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.Employee", b =>
                {
                    ...
                    b.HasOne("DreamTeam.Wod.EmployeeService.Repositories.EmployeeServiceDbContext+DismissalReasons", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.Office", b =>
                {
                    b.HasOne("DreamTeam.Wod.EmployeeService.DomainModel.ExternalOffice", "ExternalOffice")
                        .WithOne("Office")
                        .HasForeignKey("DreamTeam.Wod.EmployeeService.DomainModel.Office", "ExternalOfficeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ExternalOffice");
                });
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.RelocationCaseProgress", b =>
                {
                    ...
                    b.HasOne("DreamTeam.Wod.EmployeeService.Repositories.EmployeeServiceDbContext+RelocationPlanTrpStates", null)
                        .WithMany()
                        .HasForeignKey("TrpState")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.RelocationCaseVisaProgress", b =>
                {
                    ...
                    b.Navigation("RelocationCaseProgress");
                });
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.RelocationPlan", b =>
                {
                    ...
                    b.Navigation("RelocationCaseStatus");
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.RelocationPlanChange", b =>
                {
                    ...
                    b.Navigation("NewCaseStatus");

                    b.Navigation("NewDestination");

                    b.Navigation("NewStatus");

                    b.Navigation("PreviousCaseStatus");
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.Workplace", b =>
                {
                    ...
                    b.HasOne("DreamTeam.Wod.EmployeeService.DomainModel.Office", "Office")
                        .WithMany("Workplaces")
