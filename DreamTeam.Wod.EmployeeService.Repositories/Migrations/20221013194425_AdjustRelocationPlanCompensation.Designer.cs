...
namespace DreamTeam.Wod.EmployeeService.Repositories.Migrations
{
    ...
    [Migration("20221013194425_AdjustRelocationPlanCompensation")]
    partial class AdjustRelocationPlanCompensation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.EmployeeSnapshot", b =>
                {
                    ...
                    b.HasIndex("UnitId")
                        .HasAnnotation("SqlServer:Include", new[] { "FromDate", "ToDate", "IsActive" });
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.WspSyncLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("AffectedWorkplacesCount");
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.Repositories.EmployeeServiceDbContext+WspSyncTypes", b =>
                {
                    b.Property<string>("Id");

                    b.HasKey("Id");

                    b.ToTable("WspSyncType");

                    b.HasData(
                        new
                        {
                            Id = "DownloadExternalData"
                        },
                        new
                        {
                    ...
                    b.OwnsOne("DreamTeam.Wod.EmployeeService.DomainModel.CompensationInfoDetails", "Details", b1 =>
                        {
                            ...
                            b1.HasOne("DreamTeam.Wod.EmployeeService.DomainModel.CompensationInfo")
                                .WithOne("Details")
                                .HasForeignKey("DreamTeam.Wod.EmployeeService.DomainModel.CompensationInfoDetails", "CompensationInfoId")
                                .OnDelete(DeleteBehavior.Cascade);
                            ...
                            b1.OwnsOne("DreamTeam.Wod.EmployeeService.DomainModel.CompensationInfoDetailsItem", "Child", b2 =>
                                {
                                    ...
                                    b2.HasOne("DreamTeam.Wod.EmployeeService.DomainModel.CompensationInfoDetails")
                                        .WithOne("Child")
                                        .HasForeignKey("DreamTeam.Wod.EmployeeService.DomainModel.CompensationInfoDetailsItem", "CompensationInfoDetailsCompensationInfoId")
                                        .OnDelete(DeleteBehavior.Cascade);
                                });
                    ...
                    b.OwnsOne("DreamTeam.Wod.EmployeeService.DomainModel.PreviousCompensationInfo", "PreviousCompensation", b1 =>
                        {
                            ...
                            b1.HasOne("DreamTeam.Wod.EmployeeService.DomainModel.CompensationInfo")
                                .WithOne("PreviousCompensation")
                                .HasForeignKey("DreamTeam.Wod.EmployeeService.DomainModel.PreviousCompensationInfo", "CompensationInfoId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.WspSyncLog", b =>
                {
                    b.HasOne("DreamTeam.Wod.EmployeeService.Repositories.EmployeeServiceDbContext+WspSyncTypes")
                        .WithMany()
                        .HasForeignKey("Type")
                        .OnDelete(DeleteBehavior.Restrict);
                });
