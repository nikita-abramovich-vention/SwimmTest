...
namespace DreamTeam.Wod.EmployeeService.Repositories.Migrations
{
    ...
    [Migration("20221013091724_AddEmploymentRequestsUpdateSyncLog")]
    partial class AddEmploymentRequestsUpdateSyncLog
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DreamTeam.Wod.EmployeeService.DomainModel.SyncLog", b =>
                {
                    b.HasOne("DreamTeam.Wod.EmployeeService.Repositories.EmployeeServiceDbContext+SyncTypes")
                        .WithMany()
                        .HasForeignKey("Type")
                        .OnDelete(DeleteBehavior.Restrict);
                });
